        ...
        <div class="nav-actions">
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <div class="user-menu" id="userMenu">
                    ...
                    <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($_SESSION['username']); ?>&background=random" alt="Avatar" class="avatar">
                    <div class="user-dropdown glass">
                        <a href="views/profile.php"><i class="ph ph-user"></i> Trang cá nhân</a>
                        <a href="views/profile.php#watchlist"><i class="ph ph-bookmark-simple"></i> Phim đã lưu</a>
                        <a href="views/profile.php#goi-vip"><i class="ph ph-crown"></i> Gói dịch vụ</a>
                        <hr style="border-color: rgba(255,255,255,0.1); margin: 5px 0;">
                        <a href="api/logout.php" style="color: #ff4e50;"><i class="ph ph-sign-out"></i> Đăng xuất</a>
                    </div>
                </div>
            <?php else: ?>
                <a href="views/login.php" class="btn-gold" style="text-decoration: none; display: flex; align-items: center; justify-content: center;">
                    Đăng nhập
                </a>
            <?php endif; ?>
